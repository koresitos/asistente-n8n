...
// output[0] = TRUE (es imagen) → Procesar Imagen
// output[1] = FALSE (no es imagen) → Asistente Mocha
...
// Fix horario section: replace old horario + domingos with new enforcement
jsCode = jsCode.replace(
  '**Horario**: Lunes a Viernes 9:30am\u20137:00pm | S\u00e1bados 10:00am\u20131:30pm\n**Domingos**: Cerrado',
...
// Fix pedido section: add tamaño field
jsCode = jsCode.replace(
